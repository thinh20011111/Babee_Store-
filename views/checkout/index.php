...
<div class="checkout-steps mb-4">
    ...
    <div class="alert alert-danger mb-4">
        ...
        unset($_SESSION['order_message']); // Xóa sau khi hiển thị
        ?>
    </div>
                    ...
                    <form action="index.php?controller=cart&action=checkout" method="POST" id="checkout-form">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div id="shipping_name-error" class="invalid-feedback">Vui lòng nhập tên người nhận.</div>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="payment-methods mb-4">
                            ...
                            <!-- PayPal tạm ẩn vì chưa hỗ trợ -->
                            <!-- <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" name="payment_method" id="payment_paypal" value="paypal" disabled>
                                <label class="form-check-label" for="payment_paypal">
                                    <i class="fab fa-paypal me-2"></i> PayPal (Sắp ra mắt)
                                </label>
                            </div> -->
                        </div>
