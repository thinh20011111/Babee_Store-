                ...
                <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                    ...
                    <div class="carousel-caption d-flex flex-column justify-content-center align-items-center">
                        ...
                        <?php if (!empty($banner['link'])): ?>
                            <a href="<?php echo htmlspecialchars($banner['link']); ?>" class="btn btn-light btn-lg fade-in"><?php echo htmlspecialchars($banner['button_text'] ?? 'SHOP NOW'); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; ?>
                    ...
                    <div class="product-card h-100">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="position-relative">
                                ...
                                <?php if ($product['is_sale'] && !empty($product['sale_price']) && $product['sale_price'] < $product['price']): ?>
                                    <div class="product-badge bg-danger text-white position-absolute top-0 start-0 m-2 px-2 py-1 rounded">Sale</div>
                                <?php endif; ?>
                            </div>
...
<section class="instagram-section mb-5">
    ...
    <div class="row g-2 justify-content-center">
        <?php
        $tiktok_images = [
            'https://i.pinimg.com/736x/d9/61/a8/d961a897b5097f6fb1fcb0eb523339c1.jpg',
            'https://i.pinimg.com/736x/95/d0/eb/95d0eb7b392e0610f0fdc578e734e322.jpg',
            'https://i.pinimg.com/736x/e7/87/2f/e7872f0b8617788f433b62d9de0cef48.jpg',
            'https://i.pinimg.com/736x/a3/da/fe/a3dafeaae082215313e7324dec9d9b83.jpg'
        ];
        ?>
        <?php foreach ($tiktok_images as $index => $image): ?>
            <div class="col-6 col-md-3 col-lg-2">
                <a href="https://www.tiktok.com/@babee_studio" class="card instagram-item text-decoration-none">
                    <div class="ratio ratio-1x1">
                        <img src="<?php echo htmlspecialchars($image); ?>" class="card-img-top object-fit-cover" alt="fl_tiktok">
                    </div>
...
<!-- Newsletter Section -->
<section class="newsletter-section py-5" style="background-color: var(--primary-color, #FF2D55);">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <h3 class="text-white fw-bold mb-3">STAY IN THE LOOP</h3>
                <p class="text-white mb-4">Đăng ký nhận tin để cập nhật về hàng mới, thông tin khuyến mãi và mã giảm giá độc quyền.</p>
                <form action="index.php?controller=newsletter&action=subscribe" method="POST" class="newsletter-form">
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control form-control-lg rounded-start" placeholder="Email của bạn" required>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .banner-carousel .carousel-caption h2 { font-size: 1.5rem; margin: 15px 0 10px; }
        .banner-carousel .carousel-caption p { font-size: 1rem; margin: 10px 0 15px; }
        .banner-carousel .carousel-caption .btn { font-size: 1rem; padding: 8px 16px; }
        .hero-banner .hero-banner-image .position-absolute h1 { margin-top: 15px; }
        .hero-banner .hero-banner-image .position-absolute p { margin-top: 10px; }
    ...
    @media (max-width: 576px) {
        ...
        .banner-carousel .carousel-caption h2 { font-size: 1.2rem; margin: 10px 0; }
        .banner-carousel .carousel-caption p { font-size: 0.9rem; margin: 8px 0 12px; }
        .banner-carousel .carousel-caption .btn { font-size: 0.9rem; padding: 6px 12px; }
        .hero-banner .hero-banner-image .position-absolute h1 { margin-top: 10px; }
        .hero-banner .hero-banner-image .position-absolute p { margin-top: 8px; }
