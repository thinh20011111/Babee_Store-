    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                Edit User: <?php echo htmlspecialchars($edit_user->username); ?>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        switch($user_item['role']) {
                                            case 'admin': $role_class = 'bg-danger'; break;
                                    ...
                                    <td>
                                        <a href="index.php?page=users&action=edit&id=<?php echo $user_item['id']; ?>" class="btn btn-primary btn-sm">
