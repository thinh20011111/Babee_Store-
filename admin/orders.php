    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                Order #<?php echo htmlspecialchars($view_order->order_number); ?> Details
            </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=orders&action=view&id=<?php echo $order_item['id']; ?>" class="btn btn-primary btn-sm">
